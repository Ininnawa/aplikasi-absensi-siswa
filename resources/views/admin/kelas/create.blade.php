                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="tingkat_kelas" id="tingkat_kelas"
                                            ...
                                            <option value="VII" @if (old('tingkat_kelas') == 'VII') selected @endif>VII
                                            </option>
                                            <option value="VIII" @if (old('tingkat_kelas') == 'VIII') selected @endif>VIII
                                            </option>
                                            <option value="IX" @if (old('tingkat_kelas') == 'IX') selected @endif>IX
                                            </option>
                                        </select>
                                        @error('tingkat_kelas')
